    ...
    describe('onRequest', () => {
      ...
      // important to note that the filter that gets passed into the onRequest for get:cookies is actually
        ...
        describe('get:cookies', () => {
          ...
          it('returns no cookies if no match on the filter', async () => {
            ...
            const cookies = await bidiAutomationInstance.onRequest('get:cookies', undefined)
          ...
          it('Throws error if for some reason fetching cookies fails', async () => {
            ...
            expect(bidiAutomationInstance.onRequest('get:cookies', {})).to.be.rejectedWith(mockError)
          })
        })
        ...
        describe('get:cookie', () => {
          describe('returns cookies that match filter via', () => {
            it('cookie name', async () => {
              ...
              const cookie = await bidiAutomationInstance.onRequest('get:cookie', {
                name: 'key1',
              })
          ...
          it('returns null if no cookie is found', async () => {
            ...
            const cookies = await bidiAutomationInstance.onRequest('get:cookie', {})
          ...
          it('Throws error if for some reason fetching cookies fails', async () => {
            ...
            expect(bidiAutomationInstance.onRequest('get:cookie', {})).to.be.rejectedWith(mockError)
          })
        })
        ...
        describe('set:cookie', () => {
          it('sets a single cookie', async () => {
            ...
            const cookie = await bidiAutomationInstance.onRequest('set:cookie', cyCookie)
          ...
          it('throws an error if setting a cookie fails', async () => {
            ...
            expect(bidiAutomationInstance.onRequest('set:cookie', cookie)).to.be.rejectedWith(mockError)
          })
        ...
        describe('add:cookies', () => {
          it('adds multiple cookies', async () => {
            ...
            const returnValue = await bidiAutomationInstance.onRequest('add:cookies', cookies)
          ...
          it('throws an error if setting any cookie fails', async () => {
            ...
            expect(bidiAutomationInstance.onRequest('add:cookies', cookies)).to.be.rejectedWith(mockError)
          })
        })
        ...
        describe('set:cookies', () => {
          it('sets multiple cookies', async () => {
            ...
            const returnValue = await bidiAutomationInstance.onRequest('set:cookies', cookies)
          ...
          it('throws an error if setting any cookie fails', async () => {
            ...
            expect(bidiAutomationInstance.onRequest('set:cookies', cookies)).to.be.rejectedWith(mockError)
        ...
        describe('clear:cookie', () => {
          it('clears a single cookie and returns it\s value', async () => {
            ...
            const clearedCookie = await bidiAutomationInstance.onRequest('clear:cookie', cookieToClear)
          ...
          it('returns undefined if the cookie does not exist', async () => {
            ...
            const result = await bidiAutomationInstance.onRequest('clear:cookie', cookie)
          ...
          it('throws an error if clearing a cookie fails', async () => {
            ...
            expect(bidiAutomationInstance.onRequest('clear:cookie', cookie)).to.be.rejectedWith(mockError)
          })
        })
        ...
        describe('clear:cookies', () => {
          it('clears a single cookie and returns it\s value', async () => {
            ...
            const clearedCookie = await bidiAutomationInstance.onRequest('clear:cookies', cookiesToClear)
          ...
          it('returns undefined if the cookie does not exist', async () => {
            ...
            const result = await bidiAutomationInstance.onRequest('clear:cookies', cookies)
          ...
          it('throws an error if clearing a cookie fails', async () => {
            ...
            expect(bidiAutomationInstance.onRequest('clear:cookies', cookies)).to.be.rejectedWith(mockError)
          })
        })
      })

      it('returns "true" when "is:automation:client:connected"', async () => {
        const isAutomationClientConnected = await bidiAutomationInstance.onRequest('is:automation:client:connected', undefined)
      ...
      describe('take:screenshot', () => {
        it('successfully takes a screenshot', async () => {
          ...
          const screenshot = await bidiAutomationInstance.onRequest('take:screenshot', {})
        ...
        it('throws an error if taking a screenshot fails', async () => {
          ...
          expect(bidiAutomationInstance.onRequest('take:screenshot', {})).to.be.rejectedWith(mockError)
        })
      })
      ...
      describe('reset:browser:tabs:for:next:spec', () => {
        it('successfully recreates the test tab (shouldKeepTabOpen=true) closes all other tabs', async () => {
          ...
          const returnValue = await bidiAutomationInstance.onRequest('reset:browser:tabs:for:next:spec', {
      ...
      describe('focus:browser:window', () => {
        ...
        it('focuses the browser window (AUT should be first window)', async () => {
          ...
          const returnValue = await bidiAutomationInstance.onRequest('focus:browser:window', {})
      ...
      it('throws an error if an event passed in does not exist', () => {
        expect(bidiAutomationInstance.onRequest('foo:bar:baz', {})).to.be.rejectedWith('No automation handler registered for: \'foo:bar:baz\'')
      })
    })
  })
})
